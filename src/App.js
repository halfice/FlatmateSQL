      ...
      if (res.data != "notfound") {
        for (var i = 0; i < res.data.length; i++) {
          ...
          var obs = {
            ...
            'picstring': this.state.imgstarturl + res.data[i].picstring + this.state.imgStartEnd,//es.data[i].picstring,
