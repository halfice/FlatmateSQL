...
class bodycards extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      imgStartEndprofile:"?sp=racwl&st=2021-05-01T06:03:08Z&se=2022-04-05T14:03:08Z&spr=https&sv=2020-02-10&sr=c&sig=ES8uWD8us5uekEV4pQstzqsT%2B0Q3xfrF6fLjb47%2FaKc%3D",
  ...
  render() {
    ...
    var SubProjectArrays = this.state.ObjectArray.map((item, i) => {
      return (
        <div className="col-sm-4" key={item["key"]} onClick={this.getCarousal.bind(this, item["PropertyId"])} >
      ...
      return (
        <div className="col-sm-4 bottomspace" key={item["key"]} onClick={this.getCarousalAgent.bind(this, item["PropertyId"])} >
          <Card style={{ width: '100%' }} className="bordershadow" key={item["Type"]}>
            <div>
              <Card.Img height="150px" variant="top" src={item["Imagestr"]} onClick={this.getCarousalAgent.bind(this, item["PropertyId"])} />
            ...
            <Card.Body>
              <div className="row bottomborder" >
                ...
                <div className="col-sm-7 paragraphcss">{item["Location"]}</div>
                <div className="col-sm-5 paragraphcss">{this.formatMoney(item["Price"])}</div>
              ...
              <div className="row">
                ...
                <div className="col-sm-3">
                  <div className="myicondiv">
                    <FontAwesomeIcon icon={faParking} /><span className="paragraphcss">{item["parking"]}</span>
